...
## 🔥LAB549: Strengthen your identity security posture with Conditional Access

### Session Description

Secure your tenant with Conditional Access aligned to Zero Trust. In this hands-on lab, learn safe rollout patterns and use the CA Optimization Agent–Security Copilot in Entra–to scan daily, flag gaps, and remediate with one-click and phased enforcement.
...
- Verify the reach of a Conditional Access policy using WhatIf Analysis tool
- Block access to clou resources using Conditional Access
- Configure and use the Conditional Access Optimization Agent

### 💻 Technologies Used

1. Microsoft Entra ID
1. Microsoft Entra conditional access
1. Conditional Access Optimization agent in Microsoft Entra
